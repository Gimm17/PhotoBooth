    ...
    <div className="result-layout">
      ...
      <div className="result-controls">
        ...
        <div className="result-secondary-actions">
          <button type="button" onClick={handlePrint}><Printer aria-hidden="true" size={19} /><span><strong>Cetak langsung</strong><small>Gunakan dialog cetak perangkat</small></span></button>
          <button type="button" disabled={!saveToGallery || isSaving} onClick={() => void handleSave()}><Bookmark aria-hidden="true" size={19} /><span><strong>Simpan ke galeri</strong><small>{saveToGallery ? 'Tersimpan di perangkat ini' : 'Tersedia setelah galeri lokal aktif'}</small></span></button>
          <button type="button" onClick={() => void handleShare()}><Share2 aria-hidden="true" size={19} /><span><strong>Bagikan foto</strong><small>Gunakan opsi berbagi perangkat</small></span></button>
