...
export const FRAME_TEMPLATES = [
  ...
  { id: 'retro-sprocket', name: 'Charcoal Strip', category: 'Retro', layoutId: 'classic-strip', orientation: 'portrait', output: { width: 900, height: 1800 }, slots: strip, background: '#2C2B29', border: { color: '#E8D6AF', width: 18, radius: 0 }, caption: { ...caption, color: '#F4F0E4' } },
  { id: 'retro-sunrise', name: 'Terracotta Print', category: 'Retro', layoutId: 'polaroid-single', orientation: 'portrait', output: { width: 1200, height: 1500 }, slots: single, background: '#D77B5D', border: { color: '#F4CE9A', width: 30, radius: 0 }, caption: { ...caption, color: '#472F2B' } },
  { id: 'retro-checker', name: 'Sage Duo', category: 'Retro', layoutId: 'wide-duo', orientation: 'landscape', output: { width: 1600, height: 1000 }, slots: duo, background: '#B7C7A3', border: { color: '#4C5A45', width: 22, radius: 0 }, caption: { ...caption, color: '#293329' } },
  { id: 'retro-postage', name: 'Sepia Postcard', category: 'Retro', layoutId: 'three-postcard', orientation: 'landscape', output: { width: 1600, height: 1100 }, slots: postcard, background: '#E2C7AA', border: { color: '#6A4E3A', width: 14, radius: 8 }, caption: { ...caption, color: '#5A4032' } },
